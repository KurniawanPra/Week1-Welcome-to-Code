...
let fourthWord4 = word4.substring(18, 19);
let fourthWordLength = fourthWord4.length;
console.log('Fourth Word: ' + fourthWord4 + ', with length: ' + fourthWordLength);

let fifthWord4 = word4.substring(20, 21);
let fifthWordLength = fifthWord4.length;
console.log('Fifth Word: ' + fifthWord4 + ', with length: ' + fifthWordLength);

let sixthWord4 = word4.substring(22, 26);
let sixthWordLength = sixthWord4.length;
console.log('Sixth Word: ' + sixthWord4 + ', with length: ' + sixthWordLength);